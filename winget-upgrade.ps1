...
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Amazon.Kindle'
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Anysphere.Cursor' --custom '/MERGETASKS="addcontextmenufiles,addcontextmenufolders,!addtopath,!runcode"'
...
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'ElementLabs.LMStudio'
...
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Google.Chrome.Beta.EXE'
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Google.Chrome.Canary'
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Google.Chrome.Dev.EXE'
...
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Microsoft.AzureCLI'
winget upgrade --accept-package-agreements --accept-source-agreements --exact --silent --id 'Microsoft.AzureDataStudio'
